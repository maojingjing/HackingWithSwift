...
//  Project8
//
//  Created by Jingjing Mao on 1/18/24.
//
...
class ViewController: UIViewController {
   ...
   override func loadView() {
      ...
      @objc func submitTapped(_ sender: UIButton) {
         ...
         if !solutions.contains(answerText) {
            let ac = UIAlertController(title:  "Hint", message: "The answer is incorrect", preferredStyle: .alert)
